		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App fiori analistas",
									"targetURL": "#simplotportalsanalista-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"simplotportalsanalista-display": {
								"semanticObject": "simplotportalsanalista",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=simplot.portalsanalista",
									"url": sap.ui.require.toUrl("simplot/portalsanalista")
								}
							}
						}
					}
